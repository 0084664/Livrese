...
class TelaAnotacoesAttack extends StatefulWidget {
  @override
  _TelaAnotacoesState createState() => _TelaAnotacoesState();
}

class _TelaAnotacoesState extends State<TelaAnotacoesAttack> {
  @override
        ...
        Column(
          children: [
            ...
            Padding(
              ...
              child: Text(
                "A batalha de Eren Jäeger contra os Titãs segue sem trégua. Determinado a se vingar, ele usará um segredo para atordoar o inimigo e contará com a ajuda do Regimento para destruir os Titãs de uma vez por todas.",
