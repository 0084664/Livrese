...
class TelaAnotacoesSangue extends StatefulWidget {
  @override
  _TelaAnotacoesState createState() => _TelaAnotacoesState();
}

class _TelaAnotacoesState extends State<TelaAnotacoesSangue> {
  @override
        ...
        Column(
          children: [
            ...
            Padding(
              ...
              child: Text(
                "Quatro membros da família Clutter, do interior do Kansas, são acordados de seu sono e brutalmente assassinados. Os criminosos são dois ex-presidiários que planejam roubar 10 mil dólares mantidos em um cofre na casa.",
