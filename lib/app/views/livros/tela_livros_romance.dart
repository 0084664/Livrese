...
import 'package:tela/app/views/anotacoes_romance/tela_anotacoes_aquimica.dart';
import 'package:tela/app/views/anotacoes_romance/tela_anotacoes_perfeito.dart';
import 'package:tela/app/views/anotacoes_romance/tela_anotacoes_theupside.dart';
import 'package:tela/app/views/anotacoes_romance/tela_anotacoes_todas.dart';
import 'package:tela/app/views/tela_mapa.dart';
import 'package:tela/app/views/tela_principal.dart';

class TelaLivrosRomance extends StatefulWidget {
  TelaLivrosRomance({Key key}) : super(key: key);

  @override
  _TelaLivrosState createState() => _TelaLivrosState();
}

class _TelaLivrosState extends State<TelaLivrosRomance> {
  @override
    ...
    return Padding(
      ...
      child: GestureDetector(
          onTap: () => Navigator.of(context).push(
              MaterialPageRoute(builder: (context) => TelaAnotacoesPerfeito())),
  ...
  Widget _listaLivros2() {
    return Padding(
      ...
      child: GestureDetector(
          onTap: () => Navigator.of(context).push(
              MaterialPageRoute(builder: (context) => TelaAnotacoesUpside())),
  ...
  Widget _listaLivros3() {
    return Padding(
      ...
      child: GestureDetector(
          onTap: () => Navigator.of(context).push(
              MaterialPageRoute(builder: (context) => TelaAnotacoesQuimica())),
  ...
  Widget _listaLivros4() {
    return Padding(
      ...
      child: GestureDetector(
          onTap: () => Navigator.of(context).push(
              MaterialPageRoute(builder: (context) => TelaAnotacoesTodas())),
  ...
  Widget _constroiLinha1() {
    ...
    return Padding(
      ...
      child: Card(
        ...
        Container(
          height: 75,
          child: Image.asset("assets/image/perfeito.jpg"),
        ),
        Padding(
          padding: const EdgeInsets.all(8.0),
          child: Column(
  ...
  Widget _constroiLinha2() {
    ...
    return Padding(
      ...
      child: Card(
        ...
        Container(
          height: 75,
          child: Image.asset("assets/image/theupside.jpg"),
        ),
        Padding(
          padding: const EdgeInsets.all(8.0),
          child: Column(
  ...
  Widget _constroiLinha4() {
    ...
    return Padding(
      ...
      child: Card(
        ...
        Container(
          height: 75,
          child: Image.asset("assets/image/todasflores.jpg"),
        ),
        Padding(
          padding: const EdgeInsets.all(8.0),
          child: Column(
