...
import 'package:tela/app/views/anotacoes_biografia/tela_anotacoes_anne.dart';
import 'package:tela/app/views/anotacoes_biografia/tela_anotacoes_malala.dart';
import 'package:tela/app/views/anotacoes_biografia/tela_anotacoes_michele.dart';
import 'package:tela/app/views/anotacoes_biografia/tela_anotacoes_steve.dart';
import 'package:tela/app/views/tela_mapa.dart';
import 'package:tela/app/views/tela_principal.dart';

class TelaLivrosBiografia extends StatefulWidget {
  TelaLivrosBiografia({Key key}) : super(key: key);

  @override
  _TelaLivrosState createState() => _TelaLivrosState();
}

class _TelaLivrosState extends State<TelaLivrosBiografia> {
  @override
    ...
    return Padding(
      ...
      child: GestureDetector(
          onTap: () => Navigator.of(context).push(
              MaterialPageRoute(builder: (context) => TelaAnotacoesAnne())),
  ...
  Widget _listaLivros2() {
    return Padding(
      ...
      child: GestureDetector(
          onTap: () => Navigator.of(context).push(
              MaterialPageRoute(builder: (context) => TelaAnotacoesSteve())),
  ...
  Widget _listaLivros3() {
    return Padding(
      ...
      child: GestureDetector(
          onTap: () => Navigator.of(context).push(
              MaterialPageRoute(builder: (context) => TelaAnotacoesMalala())),
  ...
  Widget _listaLivros4() {
    return Padding(
      ...
      child: GestureDetector(
          onTap: () => Navigator.of(context).push(
              MaterialPageRoute(builder: (context) => TelaAnotacoesMichele())),
  ...
  Widget _constroiLinha3() {
    ...
    return Padding(
      ...
      child: Card(
        ...
        Container(
          height: 75,
          child: Image.asset("assets/image/malala.jpeg"),
        ),
        Padding(
          padding: const EdgeInsets.all(8.0),
          child: Column(
  ...
  Widget _constroiLinha4() {
    ...
    return Padding(
      ...
      child: Card(
        ...
        Container(
          height: 75,
          child: Image.asset("assets/image/minhahistoria.jpg"),
        ),
        Padding(
          padding: const EdgeInsets.all(8.0),
          child: Column(
