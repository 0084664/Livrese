...
import 'package:tela/app/views/anotacoes_anime/tela_anotacoes_naruto.dart';
import 'package:tela/app/views/anotacoes_anime/tela_anotacoes_attack.dart';
import 'package:tela/app/views/anotacoes_anime/tela_anotacoes_boruto.dart';
import 'package:tela/app/views/anotacoes_anime/tela_anotacoes_haikyuu.dart';
import 'package:tela/app/views/tela_mapa.dart';
import 'package:tela/app/views/tela_principal.dart';

class TelaLivrosAnime extends StatefulWidget {
  TelaLivrosAnime({Key key}) : super(key: key);

  @override
  _TelaLivrosState createState() => _TelaLivrosState();
}

class _TelaLivrosState extends State<TelaLivrosAnime> {
  @override
    ...
    return Padding(
      ...
      child: GestureDetector(
          onTap: () => Navigator.of(context).push(
              MaterialPageRoute(builder: (context) => TelaAnotacoesHaikyuu())),
  ...
  Widget _listaLivros2() {
    return Padding(
      ...
      child: GestureDetector(
          onTap: () => Navigator.of(context).push(
              MaterialPageRoute(builder: (context) => TelaAnotacoesNaruto())),
  ...
  Widget _listaLivros3() {
    return Padding(
      ...
      child: GestureDetector(
          onTap: () => Navigator.of(context).push(
              MaterialPageRoute(builder: (context) => TelaAnotacoesAttack())),
  ...
  Widget _listaLivros4() {
    return Padding(
      ...
      child: GestureDetector(
          onTap: () => Navigator.of(context).push(
              MaterialPageRoute(builder: (context) => TelaAnotacoesBoruto())),
  ...
  Widget _constroiLinha3() {
    ...
    return Padding(
      ...
      child: Card(
        ...
        Container(
          height: 75,
          child: Image.asset("assets/image/attack.jpg"),
        ),
        Padding(
          padding: const EdgeInsets.all(8.0),
          child: Column(
  ...
  Widget _constroiLinha4() {
    ...
    return Padding(
      ...
      child: Card(
        ...
        Container(
          height: 75,
          child: Image.asset("assets/image/boruto.jpg"),
        ),
        Padding(
          padding: const EdgeInsets.all(8.0),
          child: Column(
