...
class TelaAnotacoesDracula extends StatefulWidget {
  @override
  _TelaAnotacoesState createState() => _TelaAnotacoesState();
}

class _TelaAnotacoesState extends State<TelaAnotacoesDracula> {
  @override
        ...
        Column(
          children: [
            ...
            Padding(
              ...
              child: Text(
                "No século 15, a Igreja se recusa a enterrar em solo sagrado a grande paixão do líder dos Cárpatos que decide, então, renegar a instituição religiosa. Ele passa a perambular através dos séculos até encontrar a suposta reencarnação de sua amada.",
