...
class TelaAnotacoesPerfeito extends StatefulWidget {
  @override
  _TelaAnotacoesState createState() => _TelaAnotacoesState();
}

class _TelaAnotacoesState extends State<TelaAnotacoesPerfeito> {
  @override
        ...
        Column(
          children: [
            ...
            Padding(
              ...
              child: Text(
                "Rosa é uma veterinária porto-riquenha, moradora do Brooklyn, que para pagar as contas trabalha numa multinacional da construção naval. A jovem não tem sorte no amor, suas experiências sexuais e amorosas foram desastrosas, e ela tem o grave defeito de se apaixonar facilmente.",
