...
class TelaAnotacoes_codigo extends StatefulWidget {
  @override
  _TelaAnotacoesState createState() => _TelaAnotacoesState();
}

class _TelaAnotacoesState extends State<TelaAnotacoes_codigo> {
  @override
        ...
        Column(
          children: [
            ...
            Padding(
              ...
              child: Text(
                "Um novo mestre do suspense inteligente. Uma aventura empolgante e instigante. - People Magazine Um assassinato dentro do Museu do Louvre, em Paris, traz à tona uma sinistra conspiração para revelar um segredo que foi protegido por uma sociedade secreta desde os tempos de Jesus Cristo",
